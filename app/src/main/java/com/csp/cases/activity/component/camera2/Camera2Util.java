...
//            mBackgroundHandler.post(new CameraPreview.ImageSaver(reader.acquireNextImage(), mFile));
    ...
    private final CameraCaptureSession.CaptureCallback mCaptureCallback = initCameraCaptureSessionCaptureCallback();
...
//    @SuppressWarnings("SuspiciousNameCombination")
    ...
    public void openCamera(int width, int height) {
        ...
        if (ContextCompat.checkSelfPermission(mActivity, Manifest.permission.CAMERA)
            ...
            mBuilder.mErrorListener.onError(new Exception("未开启相机权限"));
...
//        }
        ...
        public Camera2Util build() {
            Camera2Util camera2Util = new Camera2Util();
