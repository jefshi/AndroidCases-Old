package com.csp.cases.activity.component.camera;
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            for (Camera.Size size : parameters.getSupportedPreviewSizes()) {
                LogCat.i("预览==" + new Size(size.width, size.height));
            ...
            for (Camera.Size size : parameters.getSupportedPictureSizes()) {
                LogCat.i("图片==" + new Size(size.width, size.height));
                mPictureSizes.add(new Size(size.width, size.height));
            }
           //mPictureSizes.add(new Size(1840, 4000));
            LogCat.i("chooseOptimalSize==" + mPreviewSizes);
            LogCat.i("chooseOptimalSize==" + mAspectRatio);
            LogCat.i("chooseOptimalSize==" + mPreviewSizes.sizes(mAspectRatio));
