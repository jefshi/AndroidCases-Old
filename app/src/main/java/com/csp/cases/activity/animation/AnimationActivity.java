...
public class AnimationActivity extends BaseListActivity {
    ...
    public List<ItemInfo> getItemInfos() {
        ...
        items.add(new ItemInfo("XML 方式实现补间动画(SET)", "onTweenByXml", "与下述使用[Java]实现效果相同（注意动画时间）"));
        ...
        items.add(new ItemInfo("-- 动画相关 --", "", ""));
        items.add(new ItemInfo("VelocityTracker", VelocityTrackerActivity.class, "帮助追踪触摸事件速率的追踪器，查看LogCat，获得本次滑动速率"));
        items.add(new ItemInfo("GestureDetector", GestureDetectorActivity.class, "手势的使用，查看LogCat，获得相关信息"));
    ...
    private Animation.AnimationListener newAnimationListener() {
        return new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                LogCat.e("newAnimationListener: onAnimationStart");

                old = DateUtil.getNowClock();
            }

            @Override
            public void onAnimationEnd(Animation animation) {
                LogCat.e("newAnimationListener: onAnimationEnd, duration = ", DateUtil.getNowClock() - old);
            }

            @Override
            public void onAnimationRepeat(Animation animation) {
                LogCat.e("newAnimationListener: onAnimationRepeat");
            }
        };
    }
    ...
    private Animator.AnimatorListener newAnimatorListener() {
        return new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                LogCat.e("onAnimationStart");
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                LogCat.e("onAnimationEnd");
            }

            @Override
            public void onAnimationCancel(Animator animation) {
                LogCat.e("onAnimationCancel");
            }

            @Override
            public void onAnimationRepeat(Animator animation) {
                LogCat.e("onAnimationRepeat");
            }
        };
     ...
     * VelocityTracker 的使用
     */
    private void onVelocityTracker() {
