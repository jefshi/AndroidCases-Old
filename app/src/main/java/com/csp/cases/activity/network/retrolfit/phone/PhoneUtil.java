...
public class PhoneUtil {
	...
	private PhoneHardwareInfo getPhoneHardInfo(Context context) {
		...
		phoneHardwareInfo.setMac(PhoneUtil.getMacAddress(context));
		phoneHardwareInfo.setIsSupportNfc(PhoneUtil.hasNfcHce(context) == false ? "0" : "1");
	...
	public static boolean isSupportHCE(Context context) {
		...
		return PhoneUtil.hasNfcHce(context) && isKitKat;
	}
