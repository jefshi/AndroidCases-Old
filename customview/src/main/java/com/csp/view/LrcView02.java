...
public class LrcView02 extends View {
	...
	public LrcView02(Context context, AttributeSet attrs) {
		super(context, attrs);
		initViews(attrs);
	}

	public LrcView02(Context context, AttributeSet attrs, int defStyleAttr) {
