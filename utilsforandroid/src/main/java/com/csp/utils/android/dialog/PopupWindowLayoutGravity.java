...
/**
 * {@link PopupWindow#showAsDropDown(View)} 的位置优化
 * Created by jzyhywxz on 2017/04/01
 * https://github.com/jzyhywxz/PopupWindow/blob/master/app/src/main/java/com/zzw/popupwindow/view/CommonPopupWindow.java
 */
public class PopupWindowLayoutGravity {
    ...
    /**
     * @param anchor        见 @see 说明
     * @param popupWindow   见 @see 说明
     * @param layoutGravity 位置
     * @param xoff          见 @see 说明
     * @param yoff          见 @see 说明
     * @see PopupWindow#showAsDropDown(View, int, int)
     */
    @Deprecated
    public static void demo(View anchor, PopupWindow popupWindow, PopupWindowLayoutGravity layoutGravity, int xoff, int yoff) {
        int[] offset = layoutGravity.getOffset(anchor, popupWindow);
        popupWindow.showAsDropDown(anchor, offset[0] + xoff, offset[1] + yoff);
    }

    public PopupWindowLayoutGravity(int gravity) {
        layoutGravity = gravity;
    }
